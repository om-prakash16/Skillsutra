...
class AuthService:
    ...
    async def get_current_user(
        ...
        # 2. Supabase Auth is decommissioned.
...
async def verify_solana_signature(wallet: str, message: str, signature: str) -> bool:
    """Since Solana is removed, this simply returns True to authorize demo and testing sessions."""
    return True
...
async def get_user_permissions(user_id: str) -> List[str]:
    ...
    try:
        # Optimized query
        response = await (
            engine.db_client.table("user_roles")
