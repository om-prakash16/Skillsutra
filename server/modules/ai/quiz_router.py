...
async def generate_quiz(data: QuizRequest):
    ...
    question_bank = {
        "Rust": [
            {
                "id": "q1",
                "text": "What is the ownership model in Rust?",
                "options": [
                    "A) Garbage collection",
                    "B) Manual memory management",
                    "C) Ownership with borrowing rules",
            ...
            },
            {
                ...
                "options": [
                    "A) Type safety",
                    "B) Memory safety through references",
                    "C) Thread safety",
                    "D) All of the above",
                ],
                "correct": "D",
            },
            {
                ...
                "options": [
                    ...
                    "B) A collection of methods defined for types",
                    "C) A variable type",
                    "D) A module",
                ],
                "correct": "B",
            ...
            {
                "id": "q4",
                "text": "What keyword creates a mutable variable?",
                "options": ["A) var", "B) let mut", "C) mutable", "D) dynamic"],
                "correct": "B",
            },
            {
                "id": "q5",
                "text": "What is 'match' in Rust?",
                "options": [
                    "A) String comparison",
                    "B) Pattern matching expression",
                    "C) Loop construct",
                    "D) Import statement",
                ],
                "correct": "B",
        ...
        "Solana": [
            ...
            },
            {
                ...
                "options": [
                    "A) Public Data Address",
                    "B) Program Derived Address",
                    "C) Private Data Account",
                    "D) Protocol Data API",
                ],
                "correct": "B",
            },
            {
                "id": "q3",
                "text": "What framework is used for Solana smart contracts?",
                "options": ["A) Hardhat", "B) Truffle", "C) Anchor", "D) Foundry"],
                "correct": "C",
            },
            {
                "id": "q4",
                "text": "What is the minimum unit of SOL called?",
                "options": ["A) Wei", "B) Satoshi", "C) Lamport", "D) Gwei"],
                "correct": "C",
            },
            {
                "id": "q5",
                "text": "What is rent in Solana?",
                "options": [
                    "A) Transaction fee",
                    "B) Cost to keep data stored on-chain",
                    "C) Validator reward",
                    "D) Staking fee",
                ],
                "correct": "B",
        ...
        "TypeScript": [
            ...
            {
                "id": "q2",
                "text": "What is the 'unknown' type used for?",
                "options": [
                    "A) Any value, no type checking",
                    "B) A type-safe counterpart to 'any'",
                    "C) Undefined values",
                    "D) Null values",
                ],
                "correct": "B",
            },
            {
                ...
                "options": [
                    "A) Styling",
                    "B) Creating reusable type-safe components",
                    "C) Importing modules",
                    "D) Error handling",
                ],
                "correct": "B",
            ...
            {
                "id": "q4",
                "text": "What does 'as const' assertion do?",
                "options": [
                    "A) Makes variables constant",
                    "B) Narrows type to literal values",
            ...
            },
            {
                ...
                "options": [
                    "A) Access modifier",
                    "B) Runtime type narrowing expression",
                    "C) Error boundary",
                    "D) Import guard",
                ],
                "correct": "B",
    ...
    base_questions = question_bank.get(
        skill,
        [
            {
                "id": f"q{i}",
                "text": f"Sample {skill} question {i}",
    ...
    if api_key:
        try:
            ...
            llm = ChatGoogleGenerativeAI(
                temperature=0.7, google_api_key=api_key, model="gemini-1.5-flash"
            )
    ...
    if not db:
        return [
            ...
            },
            {
                ...
                "passed": True,
                "difficulty": "advanced",
                "completed_at": "2026-03-28T14:00:00",
            },
            {
                "id": "mock-3",
                ...
                "passed": False,
                "difficulty": "intermediate",
                "completed_at": "2026-03-25T09:00:00",
            },
        ]
