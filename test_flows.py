...
def test_flows():
    ...
    # User 1
    res1 = signup(user1_email, "P@ssword123!", "Alice Smith")
    print("Signup User 1:", res1.status_code)
    
    # User 2
    res2 = signup(user2_email, "P@ssword123!", "Bob Jones")
    print("Signup User 2:", res2.status_code)
    
    token1 = login(user1_email, "P@ssword123!")
    token2 = login(user2_email, "P@ssword123!")
    ...
    print("Invite/Assign Role Response:", invite_res.json())
