    ...
    <div className="relative p-8 bg-card/20 backdrop-blur-xl border border-primary/10 rounded-[2.5rem] overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row gap-10 md:gap-14 items-start md:items-center">
        ...
        <div className="flex-1 space-y-4">
           ...
           <div className="flex flex-wrap gap-5 text-sm font-medium text-muted-foreground pt-2">
              ...
              <div className="flex items-center gap-1.5"><Badge variant="outline" className="bg-emerald-500/10 text-emerald-500 border-emerald-500/20 px-2 py-0.5 text-xs">{user.experienceLevel}</Badge></div>
           </div>
           ...
           <div className="space-y-2">
              ...
              <Progress value={user.completion} className="h-2.5 bg-muted/50 border border-border/50" />
           </div>
        </div>
      </div>
    </div>
