    ...
    return (
      <Card className="bg-white/5 border-white/10 p-12 text-center space-y-6">
        ...
        <div className="space-y-2">
            ...
            <p className="text-neutral-500 text-sm max-w-xs mx-auto italic">Verify your professional identity to unlock full marketplace potential.</p>
        </div>
    ...
    <Card className="bg-[#0A0A0A] border-white/10 overflow-hidden relative border-t-primary/30 group">
      ...
      <CardHeader className="border-b border-white/10">
        <div className="flex justify-between items-center">
           ...
           <span className="text-[10px] font-mono text-neutral-500 italic">Secure Engine</span>
        </div>
      ...
      <CardContent className="p-8 space-y-8">
        <div className="aspect-square rounded-2xl bg-gradient-to-br from-primary/20 to-neutral-800 border border-white/10 flex items-center justify-center relative overflow-hidden">
             ...
             <div className="absolute bottom-4 left-4 right-4 p-2 bg-black/40 backdrop-blur-md rounded-lg border border-white/5">
                <p className="text-[10px] font-black text-neutral-400 uppercase tracking-widest text-center">Verified Metadata Version</p>
        ...
        <div className="grid grid-cols-2 gap-4">
            ...
            <Button className="bg-white text-black hover:bg-neutral-200 font-bold text-xs flex items-center gap-2" onClick={onSync}>
                <RefreshCw className="w-4 h-4" /> SYNC PROFILE
            </Button>
        </div>
        ...
        <div className="pt-4 text-center">
           <div className="text-[10px] font-black text-neutral-500 uppercase tracking-widest flex items-center justify-center gap-1">
              <ShieldCheck className="w-3 h-3" /> Identity Verified by Best Hiring Tool
           </div>
        </div>
      </CardContent>
    </Card>
