      ...
      <div className="container mx-auto max-w-7xl px-4 relative z-10">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="max-w-4xl">
            ...
            <h3 className="text-5xl md:text-7xl font-extrabold tracking-tight uppercase leading-none text-foreground">
              {getVal('vision', 'title_part1', 'Hiring is')} <span className="text-rose-600 font-black italic">{getVal('vision', 'title_part2', 'Broken.')}</span>
            </h3>
            <p className="mt-8 text-lg md:text-xl text-muted-foreground font-normal leading-relaxed italic max-w-2xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
            ...
            >
              ...
              <h4 className="text-2xl font-extrabold italic uppercase tracking-tight text-foreground font-heading">The {brandName} Path</h4>
              <ul className="space-y-4 text-foreground/90 font-bold italic text-sm">
                <li className="flex gap-3 items-start">
          ...
          <motion.div variants={itemVariants} className="text-right space-y-6 ml-auto max-w-3xl">
            ...
            <h3 className="text-4xl md:text-6xl font-extrabold tracking-tight uppercase leading-none text-foreground font-heading">
            ...
            <p className="mt-8 text-lg text-muted-foreground font-normal leading-relaxed italic max-w-xl ml-auto">
