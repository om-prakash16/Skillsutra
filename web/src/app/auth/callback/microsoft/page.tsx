...
function MicrosoftCallbackHandler() {
    ...
    useEffect(() => {
        ...
        if (!code) {
            setError("No authorization code provided by Microsoft.");
            return;
        }
        ...
        const handleMicrosoftCallback = async () => {
            try {
                ...
                const res = await fetch(`${API_BASE_URL}/auth/oauth/microsoft/callback`, {
                    method: "POST",
                    headers,
                ...
                if (data.refresh_token === "linked") {
                    toast.success('Microsoft account successfully linked!');
        ...
        <div className="text-center space-y-4">
            {error ? (
                ...
                <>
                    ...
                    <div className="text-xl font-bold">Authenticating with Microsoft...</div>
