...
export default function EditableProfile() {
        ...
        try {
            ...
            const updatePayload = {
                profile: {
                    ...
                    banner_url: profileData.basic.banner
                },
    ...
    const handleUpdateAvatar = (url: string) => {
        ...
        setProfileData({ ...profileData, basic: { ...profileData.basic, avatar: url } })
    }

    const handleUpdateBanner = (url: string) => {
        if (!profileData) return
        setProfileData({ ...profileData, basic: { ...profileData.basic, banner: url } })
    }
