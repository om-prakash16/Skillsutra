        ...
        <div className="space-y-12 animate-in fade-in duration-1000 pb-20">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 border-b border-border/50 pb-10">
                ...
                <div className="flex gap-4">
                    <Button size="lg" className="h-14 px-8 bg-black border border-border text-foreground hover:bg-muted/50 font-black tracking-tighter uppercase transition-transform hover:scale-105 active:scale-95 shadow-xl shadow-white/5">
                    ...
                    <CardContent className="p-8 flex flex-col md:flex-row items-center justify-between gap-8">
                        <div className="flex items-center gap-6">
                            ...
                            <div className="space-y-1">
                                <h3 className="text-2xl font-black text-foreground uppercase italic tracking-tighter">Data Logistics Nexus</h3>
                        ...
                        <div className="flex flex-col items-end gap-3 w-full md:w-auto">
                            <Button 
                                ...
                                className={`h-16 px-10 font-black tracking-widest uppercase transition-all ${
                                    ...
                                    : 'bg-indigo-600 hover:bg-indigo-500 text-foreground shadow-lg shadow-indigo-500/20'
                                }`}
                            >
                                {isSeeding ? (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                {/* Identity Matrix */}
                <Card className="bg-muted/50 border-border backdrop-blur-xl lg:col-span-1 border-t-indigo-500/20 border-t-2 relative overflow-hidden shadow-2xl">
                    <div className="absolute top-0 right-0 w-64 h-64 bg-indigo-500/10 blur-[80px] rounded-full pointer-events-none" />
                    <CardHeader className="border-b border-border/50 pb-6">
                         <CardTitle className="text-xl flex items-center gap-3">
                            <Fingerprint className="w-6 h-6 text-indigo-500" /> Super User Identity
                        </CardTitle>
                        <CardDescription className="text-[10px] uppercase font-black tracking-widest text-muted-foreground">Immutable Ledger Footprint</CardDescription>
                    </CardHeader>
                    <CardContent className="p-6 space-y-6">
                        <div className="flex flex-col items-center py-6 text-center space-y-4">
                            ...
                            <div>
                                <h3 className="text-xl font-bold tracking-tight text-foreground">{adminName}</h3>
                                <p className="text-xs text-indigo-400 font-mono mt-1">{adminWallet}</p>
                            </div>
                        </div>

                        <div className="space-y-4 border-t border-border/50 pt-6">
                            <div className="flex items-center justify-between p-3 rounded-lg bg-black/30 border border-border/50">
                                <div className="flex items-center gap-3">
                                    <Mail className="w-4 h-4 text-muted-foreground" />
                                    <span className="text-xs font-medium text-foreground/80">Primary Auth</span>
                                </div>
                                <span className="text-xs font-mono text-foreground/90">{adminEmail}</span>
                            </div>
                            <div className="flex items-center justify-between p-3 rounded-lg bg-black/30 border border-border/50">
                                <div className="flex items-center gap-3">
                                    <Smartphone className="w-4 h-4 text-muted-foreground" />
                                    <span className="text-xs font-medium text-foreground/80">2FA Device</span>
                                </div>
                ...
                <Card className="bg-muted/50 border-border backdrop-blur-xl lg:col-span-2 border-t-rose-500/20 border-t-2 relative overflow-hidden shadow-2xl">
                    ...
                    <CardHeader className="border-b border-border/50 pb-6">
                        ...
                        <CardDescription className="text-[10px] uppercase font-black tracking-widest text-muted-foreground">API Keys & System Authentication Overrides</CardDescription>
                    </CardHeader>
                    <CardContent className="p-8 space-y-8">
                        <div>
                            <h4 className="text-sm font-bold uppercase tracking-widest text-foreground/80 mb-4">Master Gateway Keys</h4>
                            <div className="space-y-3">
                                <div className="flex items-center justify-between p-4 rounded-xl bg-background/80 border border-border/50 group hover:border-border transition-colors">
                                    <div className="space-y-1">
                                        ...
                                        <p className="text-[10px] text-muted-foreground font-mono tracking-widest">sk_prod_59fA...9bxQ <EyeOff className="w-3 h-3 inline ml-1 opacity-50" /></p>
                                    </div>
                                    <Button variant="outline" size="sm" className="bg-transparent border-border hover:bg-muted/50 text-xs">Rotate Key</Button>
                                </div>
                                <div className="flex items-center justify-between p-4 rounded-xl bg-background/80 border border-border/50 group hover:border-border transition-colors">
                                    <div className="space-y-1">
                                        <p className="text-xs font-bold text-foreground uppercase flex items-center gap-2">
                                        ...
                                        <p className="text-[10px] text-muted-foreground font-mono tracking-widest">sk_ai_92zK...1aPd <EyeOff className="w-3 h-3 inline ml-1 opacity-50" /></p>
                                    </div>
                                    <Button variant="outline" size="sm" className="bg-transparent border-border hover:bg-muted/50 text-xs">Rotate Key</Button>
                                </div>
                            </div>
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="flex items-start gap-4 p-4 rounded-xl bg-black/20 border border-border/50">
            ...
            {/* Session Logs Layout */}
            <Card className="bg-muted/50 border-border backdrop-blur-xl relative overflow-hidden shadow-2xl mt-8 border-t-emerald-500/20 border-t-2">
                <CardHeader className="border-b border-border/50 pb-6">
                    <CardTitle className="text-xl flex items-center gap-3">
                    <Globe className="w-6 h-6 text-emerald-500" /> Temporal Session Genesis
                    </CardTitle>
                    <CardDescription className="text-[10px] uppercase font-black tracking-widest text-muted-foreground">Active Network Connections</CardDescription>
                </CardHeader>
                <CardContent className="p-0">
                    <div className="overflow-x-auto">
                        <table className="w-full text-sm text-left">
                            <thead className="text-[9px] text-muted-foreground uppercase tracking-widest border-b border-border/50 bg-black/20">
                                <tr>
                            ...
                            <tbody className="divide-y divide-white/5">
                                <tr className="bg-emerald-500/5">
                                    ...
                                    <td className="px-6 py-4 text-muted-foreground text-xs">Current Active Session</td>
                                    <td className="px-6 py-4 text-right">
                                        <Badge variant="outline" className="bg-emerald-500/20 text-emerald-400 border-emerald-500/20 text-[9px]">AUTHORIZED</Badge>
                                    </td>
                                </tr>
                                <tr>
                                    <td className="px-6 py-4 font-medium text-foreground/80 flex items-center gap-3">
                                        <Smartphone className="w-4 h-4 text-muted-foreground" />
                                        iOS Mobile — Cellular Gateway
                                    </td>
                                    <td className="px-6 py-4 font-mono text-muted-foreground text-xs">17.221.X.X</td>
                                    <td className="px-6 py-4 text-muted-foreground text-xs">Yesterday, 14:22:01 UTC</td>
                                    <td className="px-6 py-4 text-right">
                                        <Badge variant="outline" className="bg-muted/50 text-muted-foreground border-border text-[9px]">TERMINATED</Badge>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
