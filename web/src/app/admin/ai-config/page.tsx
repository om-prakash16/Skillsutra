...
export default function AITuningPanel() {
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-700 max-w-4xl">
      ...
      <Card className="bg-muted/50 border-border backdrop-blur-xl shadow-2xl relative overflow-hidden group border-t-fuchsia-500/30 border-t-2">
                ...
                <>
                    <div className="space-y-4">
                        <div className="flex justify-between items-center">
                            <label className="text-sm uppercase tracking-widest font-black text-foreground/90">Skill Validation Resonance</label>
                            <span className="text-2xl font-black text-foreground">{weights.skill_match_weight}%</span>
                        </div>
                        <Slider 
                        ...
                        />
                        <p className="text-xs text-muted-foreground italic">Weight applied to verified GitHub commits and objective assessment scores.</p>
                    </div>

                    <div className="space-y-4">
                        <div className="flex justify-between items-center">
                            <label className="text-sm uppercase tracking-widest font-black text-foreground/90">Experience Vector</label>
                            <span className="text-2xl font-black text-foreground">{weights.experience_weight}%</span>
                        </div>
                        <Slider 
                        ...
                        />
                        <p className="text-xs text-muted-foreground italic">Weight applied to total years of experience and seniority trajectory.</p>
                    </div>

                    <div className="space-y-4">
                        <div className="flex justify-between items-center">
                            <label className="text-sm uppercase tracking-widest font-black text-foreground/90">Project Scope Analysis</label>
                            <span className="text-2xl font-black text-foreground">{weights.project_score_weight}%</span>
                        </div>
                        <Slider 
                        ...
                        />
                        <p className="text-xs text-muted-foreground italic">Weight applied to independent project complexity and open-source contributions.</p>
                    </div>

                    <div className="pt-6 border-t border-border space-y-4">
                        <div className="flex justify-between items-center">
                            <label className="text-sm uppercase tracking-widest font-black text-foreground/90 text-orange-500">Global Minimum Shortlist Threshold</label>
                            <span className="text-2xl font-black text-foreground">{weights.min_resonance_threshold}%</span>
                        </div>
                        <Slider 
                        ...
                        />
                        <p className="text-xs text-muted-foreground italic">The minimum AI Resonance Score required for a candidate to be visible in a recruiter's shortlist.</p>
                    </div>
                    ...
                    <div className="pt-8 border-t border-border space-y-8">
                        ...
                        <div className="space-y-4">
                            <div className="flex justify-between items-center">
                                <label className="text-sm uppercase tracking-widest font-black text-foreground/90">Question Difficulty Profile</label>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div className="space-y-4">
                                <label className="text-sm uppercase tracking-widest font-black text-foreground/90">Questions per Session</label>
                                <Input 
                                    type="number" 
                            ...
                            <div className="space-y-4">
                                <label className="text-sm uppercase tracking-widest font-black text-foreground/90">Skill Weight Importance (%)</label>
                                <Input 
                                    type="number" 
                    ...
                    <Button 
                        ...
                        className="w-full bg-fuchsia-600 hover:bg-fuchsia-500 text-foreground font-black tracking-widest uppercase mt-4 shadow-[0_0_20px_rgba(217,70,239,0.4)] h-14"
                    >
