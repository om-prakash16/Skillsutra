...
export default function StaffUserModeration() {
    ...
    return (
        <div className="space-y-12 pb-24">
                ...
                <div className="flex items-center gap-4">
                    <div className="relative group">
                        ...
                        <input 
                            ...
                            className="bg-muted/50 border border-border rounded-2xl py-3 pl-12 pr-6 text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary/40 transition-all w-[300px] backdrop-blur-md"
                        />
                    </div>
            ...
            <div className="bg-black/20 border border-border/50 rounded-[2.5rem] overflow-hidden backdrop-blur-xl">
                <AdminTable 
                ...
                >
                    ...
                    {[
                        ...
                        >
                            <td className="py-7 px-8 text-sm font-medium text-foreground">{user.full_name}</td>
                            ...
                            <td className="py-7 px-8 text-sm font-medium text-foreground/80">{user.reputation_score}</td>
                            <td className="py-7 px-8 text-sm font-medium text-muted-foreground">{user.created_at}</td>
                        </tr>
                    ))}
                </AdminTable>
            </div>
