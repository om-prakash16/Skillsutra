                        ...
                        <div className="space-y-4">
                            <div className="space-y-1">
                                ...
                                <select 
                                    ...
                                    className="w-full bg-black/45 border border-white/5 rounded-2xl p-4 text-sm text-white focus:outline-none focus:ring-2 focus:ring-primary/20 transition-all shadow-inner"
                                >
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    {myTeams.length === 0 ? (
                        <div className="text-center py-24 glass rounded-[3rem] border-white/5 border-dashed max-w-md mx-auto">
                            ...
                            <p className="text-[11px] font-black uppercase tracking-widest text-white/50">No Active Teams Joined or Led.</p>
                        </div>
                    ) : (
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            {myTeams.map((team) => (
                                <div key={team.id} className="glass border-white/5 rounded-3xl p-6 hover:border-primary/20 transition-colors space-y-6">
                                    <div>
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div className="space-y-2">
                                            {team.members?.map((member: any) => (
                                                <div key={member.user_id} className="flex items-center justify-between bg-white/5 border border-white/5 p-3 rounded-xl">
                                                    <div>
                                                        <p className="text-xs font-bold text-white">{member.users?.full_name}</p>
                                            ...
                                            {team.members
                                                ...
                                                .map((m: any) => (
                                                    <div key={m.user_id} className="flex items-center justify-between bg-red-500/5 border border-red-500/10 p-3 rounded-xl">
                                                        <div className="text-xs text-white font-medium">{m.users?.full_name}</div>
                                        ...
                                        {invitingTeamId === team.id ? (
                                            <div className="flex gap-2">
                                                <input 
                                                    ...
                                                    className="flex-1 bg-black/35 border border-white/5 rounded-lg px-3 py-2 text-xs text-white focus:outline-none"
                                                />
                                                <Button 
                                                ...
                                                <Button 
                                                    ...
                                                    className="h-9 px-3 text-[10px] font-bold tracking-widest uppercase rounded-lg hover:bg-white/5"
                                                >
                                                    CANCEL
                                                </Button>
                                            </div>
                                            ...
                                            <Button 
                                                ...
                                                className="w-full h-10 border-white/10 text-[10px] font-black uppercase tracking-widest rounded-xl hover:bg-white/5 gap-1.5"
                                            >
